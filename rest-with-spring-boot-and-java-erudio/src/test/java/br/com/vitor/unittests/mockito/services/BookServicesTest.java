...
import br.com.vitor.unittests.mapper.mocks.MockBook;
...
class BookServicesTest {
	...
	void testCreate() {
		...
		var result = service.createBookVO(vo);
	...
	void testUpdate() {
		...
		var result = service.updateBookVO(vo);
